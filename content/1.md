...
[^1]: {% cite 'Vors 1879' '5' %}. The epigraph is from {% cite 'Higgins' '592' %}.

[^2]: {% cite 'Huish 1898' '99' %}.

[^3]: {% cite 'Mathieux 2010' '17' %}.

[^4]: {% cite 'Houssay 1876' '73' %}. 

[^5]: {% cite 'de Kay 1890' '560' %}.

[^6]: {% cite 'Hutton 1899' '44' %}.

[^7]: {% cite 'Higgins 1962' '589' %}; {% cite 'Huish 1900' '100' %}. See for example {% cite 'Mahaffy 1890' '111' %}: "We must not therefore accept the jibes of the witty Athenians, in whose assumed contempt of the Bœotians, there lay the same suspicion of conscious inferiority that lies in the Irish ridicule of English stolidity."

[^8]: {% cite 'Rayet 1875a' '57' %}.

[^9]: {% cite 'Hutton 1899' '49' %}; {% cite 'Smith' '84' %}.

[^10]: "Fine Arts. The Tanagrine Figures," *Athenaeum,* 19 Nov 1892, 708.

[^11]: {% cite 'Curtis 1879' '36' %}.

[^12]: "Tanagra," *Academy,* 9 Dec 1899, 667; {% cite 'Uhlenbrock 1992' '20' %}.

[^13]: {% cite 'Huish 1900' '4' %}.
...
[^17]: {% cite 'Hutton 1899' '44' %}; "The Tanagra Statuettes," *The Art Journal,* 5 (1879): 379.
...
[^19]: Sheila Dillon, "Case Study III: Hellenistic Tanagra Figurines," in {% cite 'Dillon 2012' '233' %}; {% cite 'Bell 1993' '41' %}, presenting the research of Dorothy Burr Thompson.
...
[^24]: {% cite 'Fröhner 1888' '65' %}.

[^25]: {% cite 'Muller 2010' '101' %}.

[^26]: {% cite 'Bell 1993' '50' %}. 

[^27]: On venting the figurines, see Allen, "Made of Earth, Adorned with Beauty," xxx.

[^28]: {% cite 'Uhlenbrock 1992' '20' %}.

[^29]: {% cite 'Huish 1900' '1' %}.

[^30]: {% cite 'Fröhner' '65' %}; {% cite 'Burn' '225' %}.

[^31]: {% cite 'Bourgeois 2010' '239' %}.

[^32]: {% cite 'Fröhner' '65' %}; {% cite 'Wilde 1893' %}

[^33]: "Greece," in {% cite 'Racinet 1888' '2:52' %}; {% cite 'Rayet 1875a' '61' %}.

[^34]: {% cite 'Dillon 2012' '233' %}.

[^35]: {% cite 'Houssay 1876' '73' %}.

[^36]: On the polychromy of Tanagas, see Violaine Jeammet, Céline Knecht, Sandrine Pagès-Camagna, "The polychrome decoration on Hellenistic terracottas: figurines from Tanagra and Myrina in the collection of the Musée du Louvre," in {% cite 'Jeammet 2010' '245--49' %}.

[^37]: {% cite 'Houssay 1876' '73' %}; {% cite 'Pottier 1890' '254' %}, quoted in {% cite 'Higgins 1986' '119' %}.

[^38]: {% cite 'Vors 1879' '5' %}.

[^39]: "Greek Terra-Cottas from Tanagra and Elsewhere," *Scribner's Monthly* 21, no. 6 (Apr 1881): 925--26; {% cite 'Hutton 1899' '44' %}; "The Tanagra Statuettes," *Art Journal* 5 (1879): 380.

[^40]: {% cite 'Hughes '1896' '126' %}.

[^41]: "Art Notes," *New York Times*, May 19, 1890, 4.

[^42]: {% cite 'Lippert 2014' '107' %}.
...
[^108]: {% cite 'Rayet 1878' '350' %}.

[^109]: "Fine Arts," *Athenaeum*, Nov 1, 1890, 591

[^110]: {% cite 'Vors 1879' '5' %}.
...
[^122]: Oscar Wilde, *The Picture of Dorian Gray*, 1890, reprint, The Project Gutenberg, https://www.gutenberg.org/files/174/174-h/174-h.htm
